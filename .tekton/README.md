...
To modify the pipelines for `pipelines-components` in the `rhoai-3.5-ea.1` release:
...
```bash
git commit -am "Update pipelinerun for pipelines-components (rhoai-3.5-ea.1)"

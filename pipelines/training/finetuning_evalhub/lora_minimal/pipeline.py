...
PIPELINE_NAME = "lora-pipeline-evalhub-easy"
# =============================================================================
...
def lora_pipeline_evalhub_easy(
    # =========================================================================
    ...
    """LoRA Training Pipeline — Eval Hub Minimal.
    ...
    # =========================================================================
    # Stage 2: LoRA Training (hardcoded safe defaults)
    # =========================================================================
